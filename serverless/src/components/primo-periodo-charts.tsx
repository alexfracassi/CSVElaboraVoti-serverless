...
export function PrimoPeriodoCharts({ stats }: PrimoPeriodoChartsProps) {
  ...
  // Dati per il grafico delle insufficienze per materia (top 10)
  ...
  // Dati per la distribuzione studenti
  ...
  return (
    <div className="space-y-6">
      {/* Grafico insufficienze per materia */}
      <Card>
        <CardHeader>
      ...
      {/* Distribuzione studenti per numero insufficienze */}
      <Card>
        <CardHeader>
